...
import { setDuaLastDate, setDualFirstDate } from "../../../store/reducer/datePickerSlice";

export default function DualDatePicker({ firstInitial, lastInitial, className }) {
  ...
  return (
    <S.InpWrapper className={className}>
      ...
      {
        className !== 'user' &&
        (lastCalendar && <DatePicker calendar={lastCalendar} setCalendar={setLastCalendar} />)
      }
      </S.InpWrapper>
  )
}
