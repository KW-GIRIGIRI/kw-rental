      ...
      <S.Div>
        {
          ...
          isEquip || isLab ?
          <div>
            <input type='date' defaultValue={fromDate} onChange={handleFromDateChange} />
            <p>~</p>
            <input type='date' defaultValue={toDate} onChange={handleToDateChange} />
          </div>
          : <></>
        }
        {
            ...
            <S.HistWrap>
              ...
              {equipHistory.map((history, i) => (
                <S.HistList className="equipList" key={i}>
                  <S.DateEquip>{dayjs(history.startDate).format('YY년 MM월 DD일(dd)')}</S.DateEquip>
                  <S.DateEquip>{dayjs(history.endDate).format('YY년 MM월 DD일(dd)')}</S.DateEquip>
                  <S.ItemUl>
