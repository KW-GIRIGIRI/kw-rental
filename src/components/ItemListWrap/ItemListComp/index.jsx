...
export default function ItemListComp({ index, num, isEdit, isAdd, delItem, data, setData, setPreventAdd }) {
  ...
  return (
    <S.ItemWrap className={num && !isEdit ? "hover" : null}>
      ...
      <S.InputId onChange={handleChange} value={num || text} onKeyDown={handleKeyDown} disabled={(!isEdit && !isAdd) || (num || finish)}  placeholder="재물번호를 입력하세요." type='number' />
      {isEdit || isAdd ?
